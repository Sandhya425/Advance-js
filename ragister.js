...
//     let res=await data.json()
//       let ui=`<form>
//       <input typr="text" id="name" value="${res.name}">
//       <input typr="text" id="email" value="${res.email}">
//       <input typr="text" id="number" value="${res.number}">
//       <input typr="text" id="address" value="${res.address}">
//       <input typr="text" id="password" value="${res.password}">
...
//     let o=document.querySelector("#output")
//     o.innerHTML=res.map(a=>`<div>${e.name}</div>
// <div>${e.email}</div>
// <div>${e.number}</div>
// <div>${e.address}</div>
// <div>${e.password}</div>
